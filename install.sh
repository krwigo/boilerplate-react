...
npm pkg set scripts.build-webpack="npm run lint && webpack build --config .webpack.config.js --mode production"
npm pkg set scripts.build="npm run build-webpack"
npm pkg set scripts.serve-webpack="webpack serve --config .webpack.config.js"
npm pkg set scripts.serve="npm run serve-webpack"
cat package.json
